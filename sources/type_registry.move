module collectibleswap::type_registry {
    ...
    public entry fun initialize_script(collectibleswap_admin: &signer) {
        ...
        move_to(collectibleswap_admin, TypeRegistry { collection_to_cointype: table::new(), cointype_to_collection: table::new() });
    }

    public fun register<CoinType>(collection: String, creator: address) acquires TypeRegistry {
